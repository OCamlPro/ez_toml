...
# -*- coding: utf-8 -*-
#
# ez_toml documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ez_toml.tex', 'ez_toml Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ez_toml', 'ez_toml Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ez_toml', 'ez_toml Documentation',
     author, 'ez_toml', 'One line description of project.',
     'Miscellaneous'),
]
